...
})({"hIteX":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "460e4586cd5d0303";
"use strict";
...
},{}],"e2EPG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "DotLottieAudio", ()=>M) //# sourceMappingURL=out.js.map
;
var _chunkB7OIQIGJJs = require("./chunk-B7OIQIGJ.js");
var global = arguments[3];
var P = (0, _chunkB7OIQIGJJs.a)((S)=>{
    (function() {
        var g = function() {
            this.init();
        };
        ...
        u.prototype = {
            init: function(e) {
                var t = this;
                return r.ctx || A(), t._autoplay = e.autoplay || !1, t._format = typeof e.format != "string" ? e.format : [
                    e.format
                ], t._html5 = e.html5 || !1, t._muted = e.mute || !1, t._loop = e.loop || !1, t._pool = e.pool || 5, t._preload = typeof e.preload == "boolean" || e.preload === "metadata" ? e.preload : !0, t._rate = e.rate || 1, t._sprite = e.sprite || {}, t._src = typeof e.src != "string" ? e.src : [
                    e.src
                ], t._volume = e.volume !== void 0 ? e.volume : 1, t._xhr = {
            ...
            volume: function() {
                ...
                if (t.length === 1 || t.length === 2 && typeof t[1] > "u") {
                    ...
                    _ >= 0 ? o = parseInt(t[0], 10) : n = parseFloat(t[0]);
            ...
            rate: function() {
                ...
                if (typeof n == "number") {
                    ...
                    for(var f = 0; f < o.length; f++)if (a = e._soundById(o[f]), a) {
                        ...
                        var m = e.seek(o[f]), y = (e._sprite[a._sprite][0] + e._sprite[a._sprite][1]) / 1e3 - m, w = y * 1e3 / Math.abs(a._rate);
            ...
            seek: function() {
                ...
                if (t.length === 0) e._sounds.length && (o = e._sounds[0]._id);
                    ...
                    var l = e._getSoundIds(), _ = l.indexOf(t[0]);
                    _ >= 0 ? o = parseInt(t[0], 10) : e._sounds.length && (o = e._sounds[0]._id, n = parseFloat(t[0]));
                } else t.length === 2 && (n = parseFloat(t[0]), o = parseInt(t[1], 10));
    ...
    (function() {
        HowlerGlobal.prototype._pos = [
            ...
            if (typeof u > "u") {
                if (typeof r == "number") i._stereo = r, i._pos = [
                    r,
                    0,
                    0
                ];
            ...
            for(var d = i._getSoundIds(u), h = 0; h < d.length; h++){
                ...
                if (p) {
                    if (typeof r == "number") p._stereo = r, p._pos = [
                        r,
                        0,
                        0
            ...
            if (u = typeof u != "number" ? 0 : u, i = typeof i != "number" ? -0.5 : i, typeof c > "u") {
                if (typeof r == "number") d._pos = [
                    r,
                    u,
                    i
                ];
            ...
            if (u = typeof u != "number" ? d._orientation[1] : u, i = typeof i != "number" ? d._orientation[2] : i, typeof c > "u") {
                if (typeof r == "number") d._orientation = [
                    r,
                    u,
                    i
                ];
            ...
            for(var h = d._getSoundIds(c), p = 0; p < h.length; p++){
                var s = d._soundById(h[p]);
                if (s) {
                    if (typeof r == "number") s._orientation = [
                        r,
                        u,
                        i
            ...
            if (u.length === 1) {
                if (typeof u[0] == "object") i = u[0], typeof c > "u" && (i.pannerAttr || (i.pannerAttr = {
...
var F = (0, _chunkB7OIQIGJJs.b)(P(), 1), M = class {
    _howl;
    constructor({ src: r }){
        this._howl = new F.Howl({
            src: r
        });
    }
    play() {
...
},{"./chunk-B7OIQIGJ.js":"l9v1q","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hIteX"], null, "parcelRequire9977")

//# sourceMappingURL=dotlottie-audio.cd5d0303.js.map
