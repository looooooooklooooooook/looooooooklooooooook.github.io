...
})({"i6SAl":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "9e48228d33ed47f7";
"use strict";
...
},{}],"gcpj3":[function(require,module,exports) {
...
lottie-web/build/player/lottie_light_html.js:
   ...
   *)
*/ parcelHelpers.export(exports, "default", ()=>lottie_light_htmlSLCECTRT) //# sourceMappingURL=out.js.map
;
var _chunkB7OIQIGJJs = require("./chunk-B7OIQIGJ.js");
var Lr = (0, _chunkB7OIQIGJJs.a)((Re, ni)=>{
    typeof navigator < "u" && function(ye, le) {
        ...
        var we = function() {
                ...
                s || (s = a(function(_) {
                    function k() {
                        ...
                        function c(F) {
                            ...
                            for(m = S - 1; m >= 0; m -= 1)if (F[m].ty === "sh") {
                                if (F[m].ks.k.i) b(F[m].ks.k);
                        ...
                        var x = function() {
                            ...
                            return function(m) {
                                if (m.chars && !P(F, m.v)) {
                                    ...
                                    for(S = 0; S < o; S += 1){
                                        ...
                                        }, m.chars[S].t || (f.data.shapes.push({
                                            ty: "no"
                            ...
                            function m(o) {
                                ...
                                else if (o[f].ty === "fl" || o[f].ty === "st") {
                                    if (o[f].c.k && o[f].c.k[0].i) for(B = o[f].c.k.length, A = 0; A < B; A += 1)o[f].c.k[A].s && (o[f].c.k[A].s[0] /= 255, o[f].c.k[A].s[1] /= 255, o[f].c.k[A].s[2] /= 255, o[f].c.k[A].s[3] /= 255), o[f].c.k[A].e && (o[f].c.k[A].e[0] /= 255, o[f].c.k[A].e[1] /= 255, o[f].c.k[A].e[2] /= 255, o[f].c.k[A].e[3] /= 255);
                            ...
                            function m(o) {
                                var f, M = o.length, A, B;
                                for(f = M - 1; f >= 0; f -= 1)if (o[f].ty === "sh") {
                                    if (o[f].ks.k.i) o[f].ks.k.c = o[f].closed;
            ...
            function u(y) {
                var v = {
                    assetData: y
                }, p = s(y, this.assetsPath, this.path);
...
`), s = {}, r, n = 0, a = 0; a < i.length; a += 1)r = i[a].split(":"), r.length === 2 && (s[r[0]] = r[1].trim(), n += 1);
        ...
        H([
            ji
        ], N), N.prototype.setParams = function(t) {
        ...
        var et = function() {
            ...
            function w(v, p, c, b, P) {
                var x, T, I = 0;
                do T = p + (c - p) / 2, x = _(T, b, P) - v, x > 0 ? c = T : p = T;
        ...
        function Gs() {
            ...
            function i(l, _, k, w, C, y, v, p, c) {
                ...
                return b > P ? b > x ? T = b - P - x : T = x - P - b : x > P ? T = x - P - b : T = P - b - x, T > -0.0001 && T < 1e-4;
            }
            var s = function() {
        ...
        function Yi(t, e) {
            ...
            if (h.to) {
                ...
                var I, j, D, L, G;
                if (a = h.s.length, p = d.s || h.e, this.sh && h.h !== 1) {
                    if (t >= y) s[0] = p[0], s[1] = p[1], s[2] = p[2];
        ...
        function Ks(t, e, i, s) {
            ...
            }, this.k = !0, this.kf = !0, this.data = e, this.mult = i || 1, this.elem = t, this.container = s, this.comp = t.comp, this.v = ie, this.pv = ie, this._isFirstFrame = !0, this.getValue = He, this.setVValue = Ge, this.interpolateValue = Yi, this.effectsSequence = [
                Ki.bind(this)
            ], this.addEffect = Xe;
        }
        function Us(t, e, i, s) {
            ...
            this.effectsSequence = [
                Ki.bind(this)
            ], this.data = e, this.keyframes = e.k, this.keyframesMetadata = [], this.offsetTime = t.data.st, this.k = !0, this.kf = !0, this._isFirstFrame = !0, this.mult = i || 1, this.elem = t, this.container = s, this.comp = t.comp, this.getValue = He, this.setVValue = Ge, this.interpolateValue = Yi, this.frameId = -1;
        ...
        var st = function() {
            ...
            function m(o) {
                var f = 1e4;
                return o < 1e-6 && o > 0 || o > -0.000001 && o < 0 ? s(o * f) / f : o;
            }
            function S() {
        ...
        var $i = "";
        var ts = document.getElementsByTagName("script"), hr = ts.length - 1, es = ts[hr] || {
            src: ""
        };
        ...
        H([
            ...
            for(u = 0; u < h; u += 1)if (d = n[u], !(d.e * r < s || d.s * r > s + i)) {
                var g, E;
                d.s * r <= s ? g = 0 : g = (d.s * r - s) / i, d.e * r >= s + i ? E = 1 : E = (d.e * r - s) / i, a.push([
                    g,
                    E
                ]);
            }
            ...
            if (i === e) for(a = 0; a < u; a += 1)this.shapes[a].localShapeCollection.releaseShapes(), this.shapes[a].shape._mdf = !0, this.shapes[a].shape.paths = this.shapes[a].localShapeCollection, this._mdf && (this.shapes[a].pathsData.length = 0);
                ...
                for(a = u - 1; a >= 0; a -= 1)if (w = this.shapes[a], w.shape._mdf) {
                    for(C = w.localShapeCollection, C.releaseShapes(), this.m === 2 && u > 1 ? (c = this.calculateShapeEdges(e, i, w.totalShapeLength, p, _), p += w.totalShapeLength) : c = [
                        [
                            y,
                            v
                        ]
                    ], d = c.length, h = 0; h < d; h += 1){
        ...
        H([
            Pt
        ], Ee), Ee.prototype.initModifierProperties = function(t, e) {
        ...
        var ci = function() {
                        ...
                        if (this.v.cloneFromProps(this.pre.props), this.appliedTransformations < 1 && this.v.translate(-this.a.v[0], -this.a.v[1], this.a.v[2]), this.appliedTransformations < 2 && this.v.scale(this.s.v[0], this.s.v[1], this.s.v[2]), this.sk && this.appliedTransformations < 3 && this.v.skewFromAxis(-this.sk.v, this.sa.v), this.r && this.appliedTransformations < 4 ? this.v.rotate(-this.r.v) : !this.r && this.appliedTransformations < 4 && this.v.rotateZ(-this.rz.v).rotateY(this.ry.v).rotateX(this.rx.v).rotateZ(-this.or.v[2]).rotateY(this.or.v[1]).rotateX(this.or.v[0]), this.autoOriented) {
                            ...
                            if (d = this.elem.globalData.frameRate, this.p && this.p.keyframes && this.p.getValueAtTime) this.p._caching.lastFrame + this.p.offsetTime <= this.p.keyframes[0].t ? (g = this.p.getValueAtTime((this.p.keyframes[0].t + .01) / d, 0), E = this.p.getValueAtTime(this.p.keyframes[0].t / d, 0)) : this.p._caching.lastFrame + this.p.offsetTime >= this.p.keyframes[this.p.keyframes.length - 1].t ? (g = this.p.getValueAtTime(this.p.keyframes[this.p.keyframes.length - 1].t / d, 0), E = this.p.getValueAtTime((this.p.keyframes[this.p.keyframes.length - 1].t - .05) / d, 0)) : (g = this.p.pv, E = this.p.getValueAtTime((this.p._caching.lastFrame + this.p.offsetTime - .01) / d, this.p.offsetTime));
                                ...
                                l._caching.lastFrame + l.offsetTime <= l.keyframes[0].t ? (g[0] = l.getValueAtTime((l.keyframes[0].t + .01) / d, 0), g[1] = _.getValueAtTime((_.keyframes[0].t + .01) / d, 0), E[0] = l.getValueAtTime(l.keyframes[0].t / d, 0), E[1] = _.getValueAtTime(_.keyframes[0].t / d, 0)) : l._caching.lastFrame + l.offsetTime >= l.keyframes[l.keyframes.length - 1].t ? (g[0] = l.getValueAtTime(l.keyframes[l.keyframes.length - 1].t / d, 0), g[1] = _.getValueAtTime(_.keyframes[_.keyframes.length - 1].t / d, 0), E[0] = l.getValueAtTime((l.keyframes[l.keyframes.length - 1].t - .01) / d, 0), E[1] = _.getValueAtTime((_.keyframes[_.keyframes.length - 1].t - .01) / d, 0)) : (g = [
                                    l.pv,
                                    _.pv
                                ], E[0] = l.getValueAtTime((l._caching.lastFrame + l.offsetTime - .01) / d, l.offsetTime), E[1] = _.getValueAtTime((_._caching.lastFrame + _.offsetTime - .01) / d, _.offsetTime));
                            } else E = t, g = E;
            ...
            function a(h, d, g) {
                ...
                } else this.r = V.getProp(h, d.r || {
                    k: 0
                }, 0, U, this);
                d.sk && (this.sk = V.getProp(h, d.sk, 0, U, this), this.sa = V.getProp(h, d.sa, 0, U, this)), this.a = V.getProp(h, d.a || {
                    k: [
                        0,
                        0,
                        0
                    ]
                }, 1, 0, this), this.s = V.getProp(h, d.s || {
                    k: [
                        100,
                        100,
                        100
            ...
            a.prototype = {
                ...
                ot
            ], a), a.prototype.addDynamicProperty = n, a.prototype._addDynamicProperty = ot.prototype.addDynamicProperty;
            function u(h, d, g) {
                return new a(h, d, g);
            }
            return {
        ...
        tt.prototype.point = function(t) {
            ...
            if (t >= 1) return [
                this,
                rs(this.points[this.points.length - 1])
            ];
            ...
            return [
                new tt(this.points[0], e, r, a, !0),
                new tt(a, n, s, this.points[3], !0)
            ];
        };
        function ns(t, e) {
        ...
        function ps(t, e) {
            ...
            return r && (i[t.length - 1] = t[t.length - 1].split(r[0])[0], s[0] = e[0].split(r[1])[1]), t.length > 1 && e.length > 1 && (r = fs(t[0], e[e.length - 1]), r) ? [
                [
                    t[0].split(r[0])[0]
                ],
                [
        ...
        function us(t, e) {
            ...
            if (i.length === 1 || Ue(i[1], 1)) return n = t.split(i[0]), s = n[0], r = n[1], [
                ce(s, e),
                ce(r, e)
            ];
            n = t.split(i[0]), s = n[0];
        ...
        Ft.prototype = {
            initTransform: function() {
                var e = new st;
                this.finalTransform = {
                    mProp: this.data.ks ? ci.getTransformProperty(this, this.data.ks, this) : {
                        o: 0
                    },
                    _matMdf: !1,
                    _localMatMdf: !1,
        ...
        ge.prototype.initGradientData = function(t, e, i) {
            this.o = V.getProp(t, e.o, 0, .01, this), this.s = V.getProp(t, e.s, 1, null, this), this.e = V.getProp(t, e.e, 1, null, this), this.h = V.getProp(t, e.h || {
                ...
                k: 0
            }, 0, U, this), this.g = new Ie(t, e.g, this), this.style = i, this.stops = [], this.setGradientData(i.pElem, e), this.setGradientOpacity(e, i), this._isAnimated = !!this._isAnimated;
        ...
        ut.prototype.defaultBoxWidth = [
            0,
            0
        ], ut.prototype.copyData = function(t, e) {
        ...
        var Mr = function() {
            ...
            function s(n, a) {
                this._currentTextLength = -1, this.k = !1, this.data = a, this.elem = n, this.comp = n.comp, this.finalS = 0, this.finalE = 0, this.initDynamicPropertyContainer(n), this.s = V.getProp(n, a.s || {
                    k: 0
                }, 0, 0, this), "e" in a ? this.e = V.getProp(n, a.e, 0, 0, this) : this.e = {
                    v: 100
                }, this.o = V.getProp(n, a.o || {
                    k: 0
                }, 0, 0, this), this.xe = V.getProp(n, a.xe || {
                    k: 0
                }, 0, 0, this), this.ne = V.getProp(n, a.ne || {
                    k: 0
                }, 0, 0, this), this.sm = V.getProp(n, a.sm || {
                    k: 100
                }, 0, 0, this), this.a = V.getProp(n, a.a, 0, .01, this), this.dynamicProperties.length || this.getValue();
            }
            s.prototype = {
                getMult: function(a) {
        ...
        function ae(t, e, i) {
            this._isFirstFrame = !0, this._hasMaskedPath = !1, this._frameId = -1, this._textData = t, this._renderType = e, this._elem = i, this._animatorsData = $(this._textData.a.length), this._pathData = {}, this._moreOptions = {
                alignment: {}
            ...
            if (this.lettersChangedFlag = e, !(!this._mdf && !this._isFirstFrame && !e && (!this._hasMaskedPath || !this._pathData.m._mdf))) {
                ...
                if (this._hasMaskedPath) {
                    if (D = this._pathData.m, !this._pathData.n || this._pathData._mdf) {
                        ...
                        var G;
                        for(T = 0, g = 0; g < E; g += 1)G = Mt.buildBezierData(L.v[g], L.v[g + 1], [
                            L.o[g][0] - L.v[g][0],
                            L.o[g][1] - L.v[g][1]
                        ], [
                            L.i[g + 1][0] - L.v[g + 1][0],
                            L.i[g + 1][1] - L.v[g + 1][1]
                        ]), _.tLength += G.segmentLength, _.segments.push(G), T += G.segmentLength;
                        g = E, D.v.c && (G = Mt.buildBezierData(L.v[g], L.v[0], [
                            L.o[g][0] - L.v[g][0],
                            L.o[g][1] - L.v[g][1]
                        ], [
                            L.i[0][0] - L.v[0][0],
                            L.i[0][1] - L.v[0][1]
                        ]), _.tLength += G.segmentLength, _.segments.push(G), T += G.segmentLength), this._pathData.pi = _;
                    }
        ...
        }, ae.prototype.mHelper = new st, ae.prototype.defaultPropsArray = [], H([
            ot
        ], ae);
        function St() {}
        ...
        function he(t, e, i) {
            this.layers = t.layers, this.supports3d = !0, this.completeLayers = !1, this.pendingElements = [], this.elements = this.layers ? $(this.layers.length) : [], this.initElement(t, e, i), this.tm = t.tm ? V.getProp(this, t.tm, 0, e.frameRate, this) : {
                _placeholder: !0
            };
        }
        H([
        ...
        H([
            nt
        ], Le), Le.prototype.createComp = function(t) {
            return new he(t, this.globalData, this);
        };
        var ki = {};
        function Pi(t) {
        ...
        H([
            ...
            ], n, a, u, h, d, g, E, l = 0; l < 2; ++l)a = 6 * t[l] - 12 * e[l] + 6 * i[l], n = -3 * t[l] + 9 * e[l] - 9 * i[l] + 3 * s[l], u = 3 * e[l] - 3 * t[l], a |= 0, n |= 0, u |= 0, n === 0 && a === 0 || (n === 0 ? (h = -u / a, h > 0 && h < 1 && r[l].push(this.calculateF(h, t, e, i, s, l))) : (d = a * a - 4 * u * n, d >= 0 && (g = (-a + Oe(d)) / (2 * n), g > 0 && g < 1 && r[l].push(this.calculateF(g, t, e, i, s, l)), E = (-a - Oe(d)) / (2 * n), E > 0 && E < 1 && r[l].push(this.calculateF(E, t, e, i, s, l)))));
        ...
        function Ot(t, e, i) {
            ...
            this.or = s(this, t.ks.or, 1, U, this), this.or.sh = !0, this.rx = s(this, t.ks.rx, 0, U, this), this.ry = s(this, t.ks.ry, 0, U, this), this.rz = s(this, t.ks.rz, 0, U, this), this.mat = new st, this._prevMat = new st, this._isFirstFrame = !0, this.finalTransform = {
                mProp: this
            };
        }
        H([
        ...
        H([
            rt
        ], J), J.prototype.buildItem = Le.prototype.buildItem, J.prototype.checkPendingElements = function() {
            for(; this.pendingElements.length;){
                var t = this.pendingElements.pop();
                t.checkParenting();
            }
        ...
        function Ut(t, e, i) {
            this.layers = t.layers, this.supports3d = !t.hasMask, this.completeLayers = !1, this.pendingElements = [], this.elements = this.layers ? $(this.layers.length) : [], this.initElement(t, e, i), this.tm = t.tm ? V.getProp(this, t.tm, 0, e.frameRate, this) : {
                _placeholder: !0
            };
        }
        H([
...
},{"./chunk-B7OIQIGJ.js":"l9v1q","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["i6SAl"], null, "parcelRequire9977")

//# sourceMappingURL=lottie_light_html-SLCECTRT.33ed47f7.js.map
