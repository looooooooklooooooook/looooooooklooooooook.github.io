...
})({"gYlUw":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "658a82e5a5295fd8";
"use strict";
...
},{}],"Wr4o9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "DotLottieStateMachineManager", ()=>fr) //# sourceMappingURL=out.js.map
;
var _chunkNZJZ4CCLJs = require("./chunk-NZJZ4CCL.js");
var _chunk74T7T5LLJs = require("./chunk-74T7T5LL.js");
var _chunkGSRQSB3UJs = require("./chunk-GSRQSB3U.js");
var _chunkBHJSY5WGJs = require("./chunk-BHJSY5WG.js");
var _chunkDCAKKOYVJs = require("./chunk-DCAKKOYV.js");
...
function hr(e, t, r, n) {
    var o = {
        _event: r
    }, i = $(A(e.event) ? e.event(t, r.data, o) : e.event), a;
    if (T(e.delay)) {
        var s = n && n[e.delay];
...
var pr = function(e, t, r) {
    return v(v({}, e), {
        value: T(e.expr) ? e.expr : e.expr(t, r.data, {
            _event: r
        })
    });
}, Ve = function(e) {
...
function yr(e, t, r) {
    var n = A(e.activity) ? e.activity(t, r.data) : e.activity, o = typeof n == "string" ? {
        id: n
    } : n, i = {
        type: N.Stop,
        activity: o
...
function yt(e, t, r, n, o, i, a) {
    a === void 0 && (a = !1);
    var s = a ? [] : mr(o), u = s.length ? fe(r, n, s, t) : r, f = a ? [
        r
    ] : void 0, l = [];
    function d(y, p) {
        var S;
        switch(p.type){
            ...
            case ne:
                u = fe(u, n, [
                    p
                ], i ? void 0 : t), f == null || f.push(u);
                break;
            default:
                var F = mt(p, e.options.actions), V = F.exec;
                if (i) i(F, u, n);
                else if (V && f) {
                    var Ot = f.length - 1, ee = v(v({}, F), {
                        exec: function(nt) {
...
function wt(e, t) {
    var r, n, o, i, a, s, u, f, l = new Set(e), d = le(l), c = new Set(t);
    try {
...
function rr(e, t) {
    var r = e.exec, n = v(v({}, e), {
        exec: r !== void 0 ? function() {
...
var J = function() {
    ...
    return e.from = function(t, r) {
        ...
        var n = this;
        if (t === void 0 && (t = this.value), r === void 0 && (r = "."), T(t)) return [
            t
        ];
        var o = Object.keys(t);
...
function ir(e, t) {
    t === void 0 && (t = {});
    var r = e.initialState, n = new Set, o = [], i = !1, a = function() {
        if (!i) {
            for(i = !0; o.length > 0;){
                var f = o.shift();
...
var or = function() {
    function e(t, r) {
        ...
        var n = this;
        this.machine = t, this.delayedEventsMap = {}, this.listeners = new Set, this.contextListeners = new Set, this.stopListeners = new Set, this.doneListeners = new Set, this.eventListeners = new Set, this.sendListeners = new Set, this.initialized = !1, this.status = X.NotStarted, this.children = new Map, this.forwardTo = new Set, this._outgoingQueue = [], this.init = this.start, this.send = function(l, d) {
...
Event: `).concat(JSON.stringify(c.data)));
            ...
            if ("machine" in y) {
                if (n.status !== X.Stopped || n.parent !== y || n.state.done) {
                    ...
                    !c && n.machine.config.predictableActionArguments ? n._outgoingQueue.push([
                        y,
                        p
                    ]) : y.send(p);
                }
            } else !c && n.machine.config.predictableActionArguments ? n._outgoingQueue.push([
                y,
                l.data
            ]) : y.send(l.data);
        ...
        var o = v(v({}, e.defaultOptions), r), i = o.clock, a = o.logger, s = o.parent, u = o.id, f = u !== void 0 ? u : t.id;
        this.id = f, this.logger = a, this.clock = i, this.parent = s, this.options = o, this.scheduler = new ye({
            deferEvents: this.options.deferEvents
        }), this.sessionId = bt.bookId();
    }
    return Object.defineProperty(e.prototype, "initialState", {
        ...
        return this.status === X.Stopped ? i.complete() : (this.onDone(a), this.onStop(a)), {
            unsubscribe: function() {
        ...
        this.scheduler.clear(), this.scheduler = new ye({
            deferEvents: this.options.deferEvents
        });
        ...
        if (Q(t)) return this.spawnMachine(t, v(v({}, n), {
            id: r
        }));
        ...
        var n, o = this, i = !1, a;
        t.then(function(u) {
            i || (a = u, o.removeChild(r), o.send($(gt(r, u), {
                origin: r
            })));
        }, function(u) {
            if (!i) {
        ...
        var n, o = this, i = !1, a = new Set, s = new Set, u, f = function(c) {
        ...
        var n, o = this, i, a = t.subscribe(function(u) {
            ...
            o.removeChild(r), o.send($(st(r, u), {
                origin: r
            }));
        }, function() {
            o.removeChild(r), o.send($(gt(r), {
                origin: r
            }));
        }), s = (n = {
            id: r,
...
var Tt = "", ge = "#", $t = "*", Et = {}, _t = function(e) {
    ...
    function e(t, r, n, o) {
        ...
        }, this.idMap = {}, this.tags = [], this.options = Object.assign(_r(), r), this.parent = o == null ? void 0 : o.parent, this.key = this.config.key || (o == null ? void 0 : o.key) || this.config.id || "(machine)", this.machine = this.parent ? this.parent.machine : this, this.path = this.parent ? this.parent.path.concat(this.key) : [], this.delimiter = this.config.delimiter || (this.parent ? this.parent.delimiter : zt), this.id = this.config.id || L([
            this.machine.key
        ], _(this.path), !1).join(this.delimiter), this.version = this.parent ? this.parent.version : this.config.version, this.type = this.config.type || (this.config.parallel ? "parallel" : this.config.states && Object.keys(this.config.states).length ? "compound" : this.config.history ? "history" : "atomic"), this.schema = this.parent ? this.machine.schema : (a = this.config.schema) !== null && a !== void 0 ? a : {}, this.description = this.config.description, this.initial = this.config.initial, this.states = this.config.states ? ht(this.config.states, function(f, l) {
        ...
        u(this), this.history = this.config.history === !0 ? "shallow" : this.config.history || !1, this._transient = !!this.config.always || (this.config.on ? Array.isArray(this.config.on) ? this.config.on.some(function(f) {
            ...
            if (Q(f)) {
                ...
                var h = f.id || Dt(i.id, l);
                return i.machine.options.services = v((c = {}, c[h] = f.src, c), i.machine.options.services), Ut(v(v({
                    id: h
                }, f), {
                    src: h
                }));
    ...
    return e.prototype._init = function() {
        ...
        if (!r) return [];
        var n = function(i, a) {
            var s = A(i) ? "".concat(t.id, ":delay[").concat(a, "]") : i, u = Ge(s, t.id);
            return t.onEntry.push(Fe(u, {
                delay: i
            })), t.onExit.push(Ve(u)), u;
        ...
        return o.map(function(i) {
            var a = i.delay;
            return v(v({}, t.formatTransition(i)), {
                delay: a
            });
        });
        ...
        if (T(o)) {
            ...
            return i !== void 0 ? this.getStateNodes((r = {}, r[o] = i, r)) : [
                this,
                this.states[o]
            ];
        }
        var a = Object.keys(o), s = [
            this
        ];
...
`).concat(x.message));
        ...
        var u, f, l, d, c = this, h = a ? wt([], this.getStateNodes(a.value)) : [], y = new Set;
        try {
        ...
        var f = this._transition(a.value, a, i) || {
            ...
            source: a,
            actions: []
        }, l = wt([], this.getStateNodes(a.value)), d = f.configuration.length ? wt(l, f.configuration) : l;
        return f.configuration = L([], _(d), !1), this.resolveTransition(f, a, a.context, o, i);
        ...
        var q = nt;
        if (!y) for(we && (q = this.resolveRaisedTransition(q, {
            type: Ee
        }, i, o)); F.length;){
            var cr = F.shift();
        ...
        return n === void 0 && (n = !0), n ? t.type === "history" ? t.resolveHistory(r) : t.initialStateNodes : [
            t
        ];
        ...
        return T(i) ? [
            n.getStateNode(i)
        ] : M(jt(i).map(function(a) {
            return r.history === "deep" ? n.getFromRelativePath(a) : [
                n.states[a[0]]
            ];
        }));
...
`).concat(s.message));
        ...
        if (!this.config.on) o = [];
            ...
            var i = this.config.on, a = $t, s = i[a], u = s === void 0 ? [] : s, f = ct(i, [
                typeof a == "symbol" ? a : a + ""
            ]);
...
var fr = class {
    ...
    start(t) {
        ...
        if (typeof r > "u") throw (0, _chunkDCAKKOYVJs.h)(`invalid state machine id ${t}`);
        ...
        this._service.subscribe((n)=>{
            ...
            if (typeof n.changed > "u" || n.changed) {
                ...
                for (let i of n.nextEvents)if (ur.filter((a)=>a !== "complete" && a !== "show").includes(i)) {
                    let a = r(i);
                    this._domListeners.set(i, a), (o = this._domElement) == null || o.addEventListener(i, a, {
                        once: !0
                    });
                } else if (i === "complete") {
                    let a = r(i);
    ...
    subscribe(t) {
        throw (0, _chunkDCAKKOYVJs.h)(t.toString());
    }
    _transformToXStateSchema(t) {
        ...
        for (let a of t){
            let s = {}, u = {};
            if (u.id = a.descriptor.id, typeof a.descriptor.initial < "u" && (u.initial = a.descriptor.initial), typeof a < "u") {
                let f = a.states;
                for(let l in f)if (typeof f[l] < "u" && f[l]) {
                    ...
                    for (let S of h)if (typeof d$1[S] < "u") {
                        ...
                        if (S === ut.after) {
                            let g = m;
                            p[g.ms] = {
                                target: (n = m == null ? void 0 : m.state) != null ? n : ""
                            };
                        } else S === ut.enter ? y[(0, _chunkDCAKKOYVJs.o)(ut, S)] = {
                            target: (o$1 = m == null ? void 0 : m.state) != null ? o$1 : ""
                        } : y[(0, _chunkDCAKKOYVJs.o)(ut, S)] = {
                            target: (i$1 = m == null ? void 0 : m.state) != null ? i$1 : ""
                        };
                    }
                    s[l] = {
                        entry: ()=>{
                            !this._player.getAnimationInstance() || d$1.animationId && d$1.animationId !== this._player.currentAnimationId ? this._player.play(d$1.animationId, ()=>({
                                    ...(0, _chunkNZJZ4CCLJs.d),
                                    ...c
                                })).then(()=>{
                                this._updatePlaybackSettings(c);
                            }).catch((m)=>{
                                (0, _chunkDCAKKOYVJs.i)(`State machine error: ${m.message}`);
                            }) : this._updatePlaybackSettings(c);
                        },
                        exit: ()=>{
    ...
    _handlePlaySegments(t) {
        if (typeof t.segments == "string") this._player.goToAndPlay(t.segments, !0);
            ...
            r !== 0 && r === n && (o = r - 1), r === 0 && r === n ? this._player.goToAndPlay(r, !0) : this._player.playSegments([
                o,
                n
            ], !0);
        }
    ...
    _requiresDomElement() {
        if (!this._domElement) throw (0, _chunkDCAKKOYVJs.h)("Requires a DOM element to attach events.");
    }
...
},{"./chunk-NZJZ4CCL.js":"d5XCp","./chunk-74T7T5LL.js":"hQT15","./chunk-GSRQSB3U.js":"bF7Vk","./chunk-BHJSY5WG.js":"ZoJZe","./chunk-DCAKKOYV.js":"dtSzY","./chunk-B7OIQIGJ.js":"l9v1q","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["gYlUw"], null, "parcelRequire9977")

//# sourceMappingURL=dotlottie-state-machine-manager-2E7RUGJG.a5295fd8.js.map
